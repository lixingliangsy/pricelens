    ...
    <header className="bg-white shadow-sm border-b">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-4 text-sm">
          ...
          <a href="/products" className="text-gray-600 hover:text-brand">Products</a>
          <a href="/admin/products" className="text-gray-600 hover:text-brand">Admin</a>
        </nav>
      </div>
    </header>
      ...
      <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="text-sm space-y-1">
            ...
            <li><a className="hover:text-white" href="/terms#refunds">Refund</a></li>
            <li><a className="hover:text-white" href="mailto:hello@pricelens.app">Support</a></li>
          </ul>
        </div>
      </div>
